...
<style>
body {
    background-image: url("/bookClub/src/main/resources/static/img/124383.jpg");
}
...
<body>
        ...
        <h1 class="text-center text-dark fw-bold text-decoration-underline">Please sign in or register.</h1>
